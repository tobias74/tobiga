...
export const VirtualCyclingEn = () => {
    return (
        <Box maxWidth="800px" width="100%" my="40px" mx="auto" py={6} px={4} className="drumuri-article">
            ...
            <p>In addition to real-time riding, <strong><a href="https://drumuri.bike" target="_blank">drumuri.bike</a></strong> offers a simulation mode where users can control the speed of the ride or skip through different sections using a slider. For those looking to track their progress, the platform also supports GPX files, enabling riders to load previous workout data and challenge their past performances by displaying "ghost riders" on both the map and the 3D environment.</p>

            <p>The focus of <strong><a href="https://drumuri.bike" target="_blank">drumuri.bike</a></strong> is on giving users control over where and how they ride, offering an open-ended approach to virtual cycling. With its map-based customization and integration of Street View, it provides a versatile tool for those who enjoy setting their own routes and exploring a wide variety of locations from home.</p>
