...
export const MotionPhotoEn = () => {
    return (
        <Box maxWidth="800px" width="100%" my="40px" mx="auto" py={6} px={4} className="motionphoto-article">
            ...
            <p>With <strong><a href="https://motionphoto.gallery" target="_blank">motionphoto.gallery</a></strong>, you can easily extract and save the video portion of your motion photos directly in your browser. The entire process happens locally on your computer.</p>
